...
public class AsaActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		asaTimeToggleButton.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
...
//			seconds = seconds % 60;
			...
			asaTimeTextView.setText(timeFormat.format(new Date(millis)));
...
//			}
			...
			mHandler.postAtTime(this, start	+ (((hours*60*60) + (minutes * 60) + seconds + 1) * 1000));
		}
	};
}
